...
Companies are the foundational entity in Valentina Noir. Every resource in the API belongs to a company, making companies the federation boundary for data isolation and access control.

## The Company Model

A company represents an isolated namespace containing all the foundational elements of Valentina's system:

-   **Users** - Players, storytellers, and administrators
-   **Campaigns** - Game sessions and their settings
